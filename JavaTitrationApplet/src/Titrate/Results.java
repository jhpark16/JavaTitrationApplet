...
class Results extends Panel implements ActionListener {
	...
	public Results(Titrate applet) {
		...
		add(but3);
		textLabel = new Label(
				"Using the lab data of the acid-base solutions at equvalence points, scientists calculate");
		add(textLabel);
		textLabel2 = new Label("the concentration of the unknown solutions. The equation for this procedure is as");
		add(textLabel2);
		textLabel3 = new Label("follows.");
		add(textLabel3);
		textLabel4 = new Label("M");
		add(textLabel4);
		textLabel5 = new Label("V");
		add(textLabel5);
		textLabel6 = new Label("=");
		add(textLabel6);
		textLabel7 = new Label("M");
		add(textLabel7);
		...
		add(textLabel12);
		textLabel33 = new Label("Here, M is concentration and");
		add(textLabel33);
		textLabel34 = new Label("V is volume.");
		add(textLabel34);
		textLabel13 = new Label(
				"Step 6. Enter your data of the volume used in the text box and click the \"Calculate\"");
		add(textLabel13);
		textLabel14 = new Label("button to get the concentration of the acid-base solution. Then, compare your");
		add(textLabel14);
		textLabel35 = new Label("answer with the true value.");
		add(textLabel35);
		textLabel15 = new Label("Your data");
		add(textLabel15);
		textLabel16 = new Label("True value");
		add(textLabel16);
