...
class pHCurve extends Panel implements ActionListener {
	...
	public pHCurve(Main applet) {
		...
		add(but2);
		textLabel = new Label("A titration curve displays pH");
		add(textLabel);
		textLabel2 = new Label("versus the volume of solution");
		add(textLabel2);
		textLabel3 = new Label("added. Its shape depends on");
		add(textLabel3);
		textLabel4 = new Label("the strengths and concentrations of");
		add(textLabel4);
		textLabel5 = new Label("the acid and base used. The");
		add(textLabel5);
		textLabel6 = new Label("titration curve can be used to");
		add(textLabel6);
		textLabel7 = new Label("evaluate the equivalence point");
		add(textLabel7);
		textLabel8 = new Label("and to select a suitable indicator");
		add(textLabel8);
		textLabel9 = new Label("for the equivalence point.");
		add(textLabel9);
		textLabel11 = new Label("Step 5. This titration curve was");
		add(textLabel11);
		textLabel12 = new Label("made from your virtual lab data.");
		add(textLabel12);
		textLabel13 = new Label("Is this curve what you expected?");
		add(textLabel13);
		textLabel14 = new Label("Judge whether or not the curve is");
		add(textLabel14);
		textLabel17 = new Label("steep enough to show a proper");
		add(textLabel17);
		textLabel18 = new Label("equivalence point.");
		add(textLabel18);
