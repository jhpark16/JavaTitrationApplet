...
class Solution2 extends Panel implements ActionListener, AdjustmentListener, ItemListener, FocusListener {
	...
	public Solution2(Main applet) {
		...
		add(but2);
		textLabel = new Label("A buret is a good apparatus for the determination of the equivalence point in");
		add(textLabel);
		textLabel2 = new Label("acid-base titration. You can accurately measure the volume of solution used.");
		add(textLabel2);
		textLabel3 = new Label("A solution of the known concentration should be placed in a buret.");
		add(textLabel3);
		textLabel4 = new Label("Step 2. Choose a solution you want to put in the buret and decide the");
		add(textLabel4);
		textLabel8 = new Label("concentration and volume of the solution.");
		add(textLabel8);
